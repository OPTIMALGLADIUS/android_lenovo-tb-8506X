LOCAL_PATH := device/Lenovo/tb8768tp1_64_bsp

TARGET_BOARD_PLATFORM := mt6735               # From ro.mediatek.platform, but lowercase value
TARGET_NO_BOOTLOADER := true
TARGET_BOOTLOADER_BOARD_NAME := tb8768tp1_64_bsp     # From ro.product.board
...
DEVICE_RESOLUTION := 800x1280                 # The Resolution of your Device
...
TW_DEFAULT_BRIGHTNESS := 67                   # Set custom brightness, low is better
...
BOARD_MKBOOTIMG_ARGS := --ramdisk_offset 0x51b00000 --tags_offset 0x47880000
BOARD_RAMDISK_OFFSET := 0x15000000
BOARD_KERNEL_TAGS_OFFSET := 0x14000000
TARGET_KERNEL_ARCH := arm64
TARGET_KERNEL_HEADER_ARCH := arm64
BOARD_KERNEL_IMAGE_NAME := Image.gz-dtb
TARGET_KERNEL_SOURCE := kernel/Lenovo/TB-8506X
